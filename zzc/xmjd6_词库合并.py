#!/usr/bin/env python3
"""Platform-neutral xmjd6 ZZZC dictionary merge core."""
...
def discover_layout() -> tuple[Path, Path, Path, tuple[Path, ...], str]:
    ...
    if root_override:
        ...
        ops_search_dirs = [start_dir, start_dir / "dicts" / "xmjd6", start_dir / "zzc"]
    else:
        ...
        ops_search_dirs = search_dirs + [base / "dicts" / "xmjd6" for base in search_dirs]
...
CHAR_DICT = ROOT / "dicts" / "xmjd6" / f"{SCHEMA}.danzi.dict.yaml"
