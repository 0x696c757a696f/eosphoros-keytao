...
| --- | ---: | ---: | ---: | --- |
| Full | 1,175,722 | 57,147 | 4.861% | Lite + 宗派专题 + ICE + 万象专业 + `fjcy` |
| Standard | 661,711 | 21,443 | 3.241% | Lite + 宗派专题 + ICE + 万象专业 |
| Lite | 251,479 | 12,027 | 4.783% | 用户词库 + 单字 + 基础词组 + 核心码 + `i` 英文 |
...
| 词库 | 记录数 | 用途 |
| --- | ---: | --- |
| `dicts/eosphoros/eosphoros.danzi.dict.yaml` | 36,288 | 上游键道单字表 |
...
| `dicts/eosphoros/eosphoros.ice.dict.yaml` | 360,382 | Rime-Ice 中文精简补充词库 |
| `dicts/eosphoros/eosphoros.wanxiang.*.dict.yaml` | 45,949 | 七个万象分类补充词库 |
| `dicts/eosphoros/eosphoros.en.dict.yaml` | 23,639 | Rime-Ice 英文词库 |
| **合计** | **1,175,722** | 不含动态自造词和个人词库 |
