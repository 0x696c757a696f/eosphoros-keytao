...
| --- | ---: | ---: | ---: | --- |
| Full | 1,175,747 | 57,144 | 4.860% | Lite + 宗派专题 + ICE + 万象专业 + `fjcy` |
| Standard | 661,736 | 21,435 | 3.239% | Lite + 宗派专题 + ICE + 万象专业 |
| Lite | 251,432 | 12,020 | 4.781% | 用户词库 + 单字 + 基础词组 + 核心码 + `i` 英文 |
