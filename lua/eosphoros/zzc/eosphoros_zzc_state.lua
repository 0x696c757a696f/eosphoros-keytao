...
M.fields = {
    stage = "_eosphoros_zzc_stage",
    word = "_eosphoros_zzc_word",
    items = "_eosphoros_zzc_items",
    len = "_eosphoros_zzc_len",
    pending = "_eosphoros_zzc_pending",
    mode = "_eosphoros_zzc_mode",
    target = "_eosphoros_zzc_target",
    origin = "_eosphoros_zzc_origin",
    display = "_eosphoros_zzc_display",
    replaced = "_eosphoros_zzc_replaced",
    cmd_candidates = "_eosphoros_zzc_cmd_candidates",
    shorten_idx = "_eosphoros_zzc_shorten_idx",
    finalize = "_eosphoros_zzc_finalize",
}
